...
class myApp(MDApp):
    ...
    # Sostituire     la prima e l'ultima graffa
        ...
        if i== len(expression):  
        #tx="{4+(3^2+8/9)}"
#expression" {4+(3^2+\frac{8}{9})}"
###  serve er avere { }  esterni  come {4+(3^2+8/9)} 
                ...
                for p in parentesi:
                    ...
                    try:
                        ...
                        if risultato_parentesi < 0:
                            ...
                            print(x)
                            print(f" line 715 in risolvi_espressione espressione[x-1]: { espressione[x-1]}")
                            print(f" line 715 in risolvi_espressione espressione[0]: { espressione[0]}")
                            if espressione[x-1]== '+':
