        ...
        for aperta, chiusa in parentesi_ordine:
            while aperta in espressione and chiusa in espressione:
                ...
                for p in parentesi:
                    ...
                    self.passi.append(f"Risolviamo la parentesi {aperta}{' _ _ _ '}{chiusa}: ${self.replace_fractions(contenuto_parentesi,0,0)}$")
                ...
                self.passi.append(f"Espressione dopo la risoluzione delle parentesi {aperta}{' _ _ '}{chiusa}: ${ text_fr_grarffe }$")    
